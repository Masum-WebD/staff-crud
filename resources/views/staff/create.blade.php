...
<body>
    ...
    <section class="w-50 bg-body-secondary mx-auto my-5">
        <form class="p-4" action="{{route('staff.store')}}" method="post">
            @csrf
            @method('post')
            ...
            <div class="form-group mb-1">
              ...
              <input type="date" class="form-control" id="exampleInputPassword1" placeholder="Select date" name="date" required>
            </div>
